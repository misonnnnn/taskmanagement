                    ...
                    <div class="w-100 shadow p-4">
                        ...
                        <div>
                            ...
                            <div class="mb-2">
                                ...
                                <div class="login_input_outer position-relative">
                            ...
                            <div class="mb-2">
                                ...
                                <div class="login_input_outer position-relative">
                                    <input type="password" id="password_confirmation" name="password_confirmation" class="col login_input passwordField form-control form-control-sm" required placeholder="password">
                                    <div class="position-absolute end-0 showPassword" style="top:5px;margin-right:10px;">
                                        <i class="showPasswordEyeIcon fa fa-eye-slash"></i>
                                    </div>
                                </div>
